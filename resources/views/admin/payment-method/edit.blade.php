    ...
    <div class="card">
        <div class="card-body flex flex-col p-6">
            ...
            <div class="card-text h-full ">
                <form class="space-y-4" method="POST" action="{{ route('admin.payment-method.update', $paymentMethod->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="input-area relative">
                        ...
                        <input type="text" id="bank_name" name="bank_name" class="form-control"
                            placeholder="Enter Bank Name" value="{{ $paymentMethod->bank_name }}"
                            {{ $editable ? '' : 'disabled' }}>
                    ...
                    <div class="input-area relative">
                        ...
                        <input type="text" id="username" name="username" class="form-control"
                            placeholder="Enter User Name" value="{{ $paymentMethod->username }}"
                            {{ $editable ? '' : 'disabled' }}>
                    ...
                    <div class="input-area relative">
                        ...
                        <input type="number" id="rekening" name="rekening" class="form-control"
                            placeholder="Enter Rekening" value="{{ $paymentMethod->rekening }}"
                            {{ $editable ? '' : 'disabled' }}>
